...
<div class="flex flex-col items-center justify-start gap-2 lg:gap-5">
	<svg
		...
		/><g id="SVGRepo_iconCarrier">
			<title>location</title> <desc>Created with Sketch Beta.</desc> <defs />
			<g
				id="Page-1"
				stroke="none"
				stroke-width="0"
...
<div class="flex flex-col items-center justify-start gap-2 lg:gap-5">
	<svg height="60px" width="60px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
		><g id="SVGRepo_bgCarrier" stroke-width="0" /><g
			id="SVGRepo_tracerCarrier"
			stroke-linecap="round"
			stroke-linejoin="round"
		/><g id="SVGRepo_iconCarrier">
			<path
				...
				stroke={$currentMainThemeColors.overlaySecondaryColor}
				stroke-width="2"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
