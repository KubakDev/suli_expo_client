...
>
	...
	{#each items as item}
		...
		<div
			class="  flex py-3 md:flex-row flex-col items-start cursor-pointer bg-opacity-20 hover:bg-slate-400 dark:bg-opacity-40 rounded-xl transition-all"
		...
		>
			...
			<div
				class="lg:flex-grow lg:w-3/4 md:w-1/2 lg:px-5 md:pl-4 flex flex-col md:items-start md:text-left items-center text-start text-[var(--onBackgroundColor)]"
			>
