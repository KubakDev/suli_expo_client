...
const themeStore = () => {
	...
	return {
		...
		getActiveTheme: async (supabase: SupabaseClient) => {
			...
			root.style.setProperty('--transparentSecondaryColor', data.secondaryColor + '10');
			root.style.setProperty('--transparentOverlaySecondaryColor', data.onSecondaryColor + '80');
			root.style.setProperty('--transparentPrimaryColor', data.primaryColor + '80');
			root.style.setProperty('--transparentOverlayPrimaryColor', data.onPrimaryColor + '80');
			root.style.setProperty('--transparentBackgroundColor', data.backgroundColor + '80');
			root.style.setProperty('--transparentOverlayBackgroundColor', data.onBackgroundColor + '80');
